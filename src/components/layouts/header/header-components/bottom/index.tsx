...
import { Box, FormLabel, Image, Input, InputGroup, InputLeftElement, Text } from "@chakra-ui/react";
  ...
  return (
    <Box className="bottom">
      ...
      <InputGroup className="bottom--input--group">
        ...
        <Input id="input" className="input" type="search" placeholder="Поиск среди 9 873 190 компонентов, электроники, приборов, электрики, автозапчастей, инструментов, сантехники…" />
      </InputGroup>
    </Box>
  );
};
